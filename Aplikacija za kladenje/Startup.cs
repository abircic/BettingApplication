...
namespace Aplikacija_za_kladenje
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddIdentity<AppUser, IdentityRole>(options =>
             ...
             }).AddEntityFrameworkStores<Aplikacija_za_kladenjeContext>();
            ...
            services.AddDbContext<Aplikacija_za_kladenjeContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("Aplikacija_za_kladenjeContext")));
        }
